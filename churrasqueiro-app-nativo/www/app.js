...
async function configurarPusher() {
    try {
        ...
        canal.bind('versao-app-atualizada', (data) => {
            ...
            if (isNativeApp) {
                verificarAtualizacaoApk('churrasqueiro', true);
            } else {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            if (typeof exibirTelaCarregamentoSistema === 'function') {
              exibirTelaCarregamentoSistema('⚡ Aplicativo Bloqueado', 'Baixando nova versão do sistema. Instale o APK baixado para poder voltar a utilizar o ChurrasqueiroExpress.');
            }
          }
        });
      }
